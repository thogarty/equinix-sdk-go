...
// checks if the RoutingProtocolRequestStatic type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoutingProtocolRequestStatic{}

// RoutingProtocolRequestStatic struct for RoutingProtocolRequestStatic
type RoutingProtocolRequestStatic struct {
...
type _RoutingProtocolRequestStatic RoutingProtocolRequestStatic
...
func NewRoutingProtocolRequestStatic(type_ string) *RoutingProtocolRequestStatic {
	this := RoutingProtocolRequestStatic{}
	this.Type = type_
	return &this
}
...
func (o RoutingProtocolRequestStatic) MarshalJSON() ([]byte, error) {
...
func (o RoutingProtocolRequestStatic) ToMap() (map[string]interface{}, error) {
...
func (o *RoutingProtocolRequestStatic) UnmarshalJSON(data []byte) (err error) {
	...
	varRoutingProtocolRequestStatic := _RoutingProtocolRequestStatic{}

	err = json.Unmarshal(data, &varRoutingProtocolRequestStatic)

	if err != nil {
		return err
	}

	*o = RoutingProtocolRequestStatic(varRoutingProtocolRequestStatic)
...
type NullableRoutingProtocolRequestStatic struct {
	value *RoutingProtocolRequestStatic
	isSet bool
}

func (v NullableRoutingProtocolRequestStatic) Get() *RoutingProtocolRequestStatic {
	return v.value
}

func (v *NullableRoutingProtocolRequestStatic) Set(val *RoutingProtocolRequestStatic) {
	v.value = val
	v.isSet = true
}

func (v NullableRoutingProtocolRequestStatic) IsSet() bool {
	return v.isSet
}

func (v *NullableRoutingProtocolRequestStatic) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRoutingProtocolRequestStatic(val *RoutingProtocolRequestStatic) *NullableRoutingProtocolRequestStatic {
	return &NullableRoutingProtocolRequestStatic{value: val, isSet: true}
}

func (v NullableRoutingProtocolRequestStatic) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRoutingProtocolRequestStatic) UnmarshalJSON(src []byte) error {
	v.isSet = true
