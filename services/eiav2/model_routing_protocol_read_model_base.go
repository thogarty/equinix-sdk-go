...
// checks if the RoutingProtocolReadModelBase type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoutingProtocolReadModelBase{}

// RoutingProtocolReadModelBase struct for RoutingProtocolReadModelBase
type RoutingProtocolReadModelBase struct {
...
type _RoutingProtocolReadModelBase RoutingProtocolReadModelBase
...
func NewRoutingProtocolReadModelBase(type_ string, name string, changeLog ChangeLog) *RoutingProtocolReadModelBase {
	this := RoutingProtocolReadModelBase{}
	this.Type = type_
	this.Name = name
...
func (o RoutingProtocolReadModelBase) MarshalJSON() ([]byte, error) {
...
func (o RoutingProtocolReadModelBase) ToMap() (map[string]interface{}, error) {
...
func (o *RoutingProtocolReadModelBase) UnmarshalJSON(data []byte) (err error) {
	...
	varRoutingProtocolReadModelBase := _RoutingProtocolReadModelBase{}

	err = json.Unmarshal(data, &varRoutingProtocolReadModelBase)

	if err != nil {
		return err
	}

	*o = RoutingProtocolReadModelBase(varRoutingProtocolReadModelBase)
...
type NullableRoutingProtocolReadModelBase struct {
	value *RoutingProtocolReadModelBase
	isSet bool
}

func (v NullableRoutingProtocolReadModelBase) Get() *RoutingProtocolReadModelBase {
	return v.value
}

func (v *NullableRoutingProtocolReadModelBase) Set(val *RoutingProtocolReadModelBase) {
	v.value = val
	v.isSet = true
}

func (v NullableRoutingProtocolReadModelBase) IsSet() bool {
	return v.isSet
}

func (v *NullableRoutingProtocolReadModelBase) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRoutingProtocolReadModelBase(val *RoutingProtocolReadModelBase) *NullableRoutingProtocolReadModelBase {
	return &NullableRoutingProtocolReadModelBase{value: val, isSet: true}
}

func (v NullableRoutingProtocolReadModelBase) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRoutingProtocolReadModelBase) UnmarshalJSON(src []byte) error {
	v.isSet = true
